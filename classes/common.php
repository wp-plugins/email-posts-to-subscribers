...
class elp_cls_common
{
	...
	public static function download($arrays, $filename = 'output.csv', $option) 
	{
		$string = '';
		$c=0;
		$filename = ELP_TDOMAIN.$option.'_'.date('Ymd_His').".csv";
	...
	public static function elp_sent_report_plain() 
	{
		...
		$report = $report. "Newsletter has been sent successfully to ###COUNT### email(s). Please find the details below.\n\n";
		$report = $report. "Unique ID : ###UNIQUE### \n";
		$report = $report. "Start Time: ###STARTTIME### \n";
		$report = $report. "End Time: ###ENDTIME### \n";
		$report = $report. "For more information, Login to your Dashboard and go to Sent Report menu in Email Posts. \n\n";
	...
	public static function elp_sent_report_html() 
	{
		...
		$report = $report. "Newsletter has been sent successfully to ###COUNT### email(s). Please find the details below.<br/><br/>";
		$report = $report. "Unique ID : ###UNIQUE### <br/>";
		$report = $report. "Start Time: ###STARTTIME### <br/>";
		$report = $report. "End Time: ###ENDTIME### <br/>";
		$report = $report. "For more information, Login to your Dashboard and go to Sent Report menu in Email Posts. <br/><br/>";
